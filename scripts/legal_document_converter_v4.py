#!/usr/bin/env python3
"""
Legal Document PDF to DOCX Converter v4
========================================

Enhanced converter with AI-powered list detection and proper formatting
for legal documents including ordered lists and numbered paragraphs.
"""
...
class LegalDocumentConverterV4:
    """Enhanced legal document converter with AI-powered list detection."""
    ...
    def create_legal_document_structure(self, document, blocks):
        ...
        # Merge list items
        merged_blocks = self.merge_list_items(blocks)
...
def main():
    ...
    if len(sys.argv) != 3:
        print("Usage: python legal_document_converter_v4.py <input.pdf> <output.docx>", file=sys.stderr)
        sys.exit(1)
    ...
    # Convert PDF to DOCX
    converter = LegalDocumentConverterV4()
    try:
