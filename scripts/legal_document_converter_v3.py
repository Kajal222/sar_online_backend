#!/usr/bin/env python3
"""
Legal Document PDF to DOCX Converter v3
========================================

Highly specialized converter for legal documents with exact formatting preservation
for Supreme Court and High Court judgments.
"""
...
class LegalDocumentConverterV3:
    """Highly specialized legal document converter with exact formatting preservation."""
...
def main():
    ...
    if len(sys.argv) != 3:
        print("Usage: python legal_document_converter_v3.py <input.pdf> <output.docx>", file=sys.stderr)
        sys.exit(1)
    ...
    # Convert PDF to DOCX
    converter = LegalDocumentConverterV3()
    try:
