#!/usr/bin/env python3
"""
Enhanced PDF to DOCX Converter v3 for Legal Documents
====================================================

Final improved version with perfect numbered list formatting and alignment.
"""
...
def main():
    ...
    if len(sys.argv) != 3:
        print("Usage: python enhanced_pdf_to_docx_v3.py <input.pdf> <output.docx>", file=sys.stderr)
        sys.exit(1)
